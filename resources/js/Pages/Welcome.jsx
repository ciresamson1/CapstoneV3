    ...
    return (
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                />
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-brand-500 selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:col-start-2 lg:justify-center">
                                <svg
                                    className="h-12 w-auto text-white lg:h-16 lg:text-brand-500"
                                    viewBox="0 0 62 65"
                                    fill="none"
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    <Link
                                        ...
                                        className="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-brand-500 dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                <a
                                    ...
                                    id="docs-card"
                                    className="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-brand-500 md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-brand-500"
                                >
                                    <div
                                    ...
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        ...
                                        >
                                            <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-brand-500/10 sm:size-16">
                                                <svg
                                        ...
                                        <svg
                                            className="size-6 shrink-0 stroke-brand-500"
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            strokeWidth="1.5"
                                ...
                                <a
                                    ...
                                    className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-brand-500 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-brand-500"
                                >
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-brand-500/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                    ...
                                    <svg
                                        className="size-6 shrink-0 self-center stroke-brand-500"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        strokeWidth="1.5"
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            ...
                                            <a
                                                ...
                                                className="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-brand-500 dark:hover:text-white dark:focus-visible:ring-brand-500"
                                            >
                                                Forge
                                            </a>
                                            ,{' '}
                                            <a
                                                ...
                                                className="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-brand-500 dark:hover:text-white"
                                            >
                                                Vapor
                                            </a>
                                            ,{' '}
